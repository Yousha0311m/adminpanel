                ...
                <div class="grid-body no-border">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="add.php" class="btn btn-primary tip" data-toggle="tooltip" title="Create"><i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                       ...
                       <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Brand Title</td>
                                <td align="center">Image will be here</td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <a href="#" class="label label-important" onClick="return confirm('Are you sure you want to delete this?')"> <i class="fa fa-trash-o"></i></a>    
                                </td>
                            </tr>
                        </tbody>
                    </table>
